(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function n(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerpolicy&&(a.referrerPolicy=s.referrerpolicy),s.crossorigin==="use-credentials"?a.credentials="include":s.crossorigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(s){if(s.ep)return;s.ep=!0;const a=n(s);fetch(s.href,a)}})();function C(e,...t){return String.raw({raw:e},...t)}function Ue(e){return new Promise(t=>setTimeout(t,e))}function Ce(e,t){if(!(e instanceof MouseEvent))return!1;const{clientX:n,clientY:i}=e,{top:s,left:a,width:r,height:d}=t.getBoundingClientRect();return s<=i&&a<=n&&n<=a+r&&i<=s+d}const Je=[{name:"Home",href:"#home"},{name:"About",href:"#about"},{name:"Favorite",href:"#favorite"},{name:"Menu",href:"#menu"},{name:"Gallery",href:"#gallery"},{name:"Contact",href:"#contact"}];function Qe(){return C`
  ...
  `}const tt=[{name:"Bubur Ayam Kampung",price:25e3,description:"Bubur dengan daging ayam pilihan ditambah cakwe, dibalur dengan minyak wijen impor yang spesial dibuat di Malaysia menghasilkan bubur yang bukan hanya mengenyangkan, tetapi juga bermakna di hati",image:"/assets/offer/offer-2.webp"},{name:"Bubur Polos",price:18e3,description:"Bubur polos yang diproses dengan kaldu ayam kampung pilihan, dipadu dengan minyak wijen pilihan menghasilkan bubur yang sangat bernutrisi dan nikmat",image:"/assets/offer/offer-1.webp"},{name:"Telur Asin",price:8e3,description:"Telur Bebek yang dipilih dengan hati dan diasinkan dengan rasa yang pas menghasilkan telur asin yang berkualitas tinggi",image:"/assets/offer/offer-3.webp"}],nt=new Intl.NumberFormat("id-ID",{style:"currency",currency:"IDR",minimumFractionDigits:0});function ke(e){return nt.format(e)}function it({name:e,price:t,image:n,index:i,description:s}){const r=`fade-delay-${(1+i%3)*100}`;return C`
    <div
  ...
  `}const lt=["utama","topping","lainnya"];function ot(){return C`
    <section
      id="menu"
    ...
    >
      ...
      <div class="main-container md:min-h-[616px]">
        ${at.reduce((e,{category:t,products:n})=>e+rt({category:t,products:n}),"")}
      </div>
    </section>
  `}const dt=[{name:"Bubur Ayam Kampung",image:"/assets/offer/offer-1.webp"},{name:"Bubur Polos",image:"/assets/offer/offer-2.webp"},{name:"Telur Asin",image:"/assets/menu/topping/topping-1.webp"},{name:"Telur Ayam Kampung",image:"/assets/menu/topping/topping-2.webp"},{name:"Ati Ampela",image:"/assets/menu/topping/topping-3.webp"},{name:"Cakwe",image:"/assets/menu/topping/topping-4.webp"}];function ct(){return C`
    <section
      id="gallery"
    ...
    >
      ...
      >
        ${dt.reduce((e,{name:t,image:n})=>e+C`
              <img
  ...
  `}const ut=[{href:"https://goo.gl/maps/PxD3wGwbXDKQP5ML9",style:"hover:bg-red-400 focus-visible:bg-red-400",title:"Location",iconName:"MapPinIcon"},{href:"mailto:site@buburnusantara.com",style:"hover:bg-blue-400 focus-visible:bg-blue-400",title:"Email",iconName:"AtIcon"},{href:"tel:+6285692807048",style:"hover:bg-green-400 focus-visible:bg-green-400",title:"Phone",iconName:"PhoneIcon"},{href:"https://www.instagram.com/buburnusantara.id",style:"hover:bg-rose-400 focus-visible:bg-rose-400",title:"Instagram",iconName:"InstagramIcon"},{href:"https://wa.me/6285692807048",style:"hover:bg-green-400 focus-visible:bg-green-400",title:"WhatsApp",iconName:"WhatsAppIcon"}],ft={AtIcon:vt,XMarkIcon:mt,PhoneIcon:gt,MapPinIcon:pt,SpinnerIcon:bt,WhatsAppIcon:wt,InstagramIcon:yt,PaperAirplaneIcon:ht};function _({style:e,iconName:t}){const n=ft[t];return n({style:e!=null?e:"h-6 w-6"})}function pt({style:e}){return C`
    <svg
  ...
  `}function xt({id:e,type:t,label:n,style:i,customId:s,useTextArea:a}){return C`
    <div
  ...
  `}const Tt=[{id:"name",label:"Name"},{id:"email",type:"email",label:"Email",customId:"contact-email"},{id:"message",label:"Message",customId:"contact-message",useTextArea:!0}];function St(){return C`
    <section
      id="contact"
      ...
      >
        ...
        >
          ...
          <div class="flex flex-wrap justify-center gap-4">
            ${ut.reduce((e,{href:t,style:n,title:i,iconName:s})=>e+C`
                  <a
                    href="${t}"
  ...
  `}const Ct=[{title:"Restaurant",links:[{name:"Testimonials",href:"#"},{name:"Commerce",href:"#"},{name:"Our Chefs",href:"#"},{name:"Events",href:"#"}]},{title:"More",links:[{name:"Breakfast",href:"#"},{name:"Lunch",href:"#"},{name:"Dinner",href:"#"}]}],kt=[{day:"Monday",open:"07:00 - 20:00"},{day:"Tuesday",open:"07:00 - 20:00"},{day:"Wednesday",open:"07:00 - 20:00"},{day:"Thursday",open:"Closed"},{day:"Friday",open:"07:00 - 20:00"},{day:"Saturday",open:"07:00 - 20:00"},{day:"Sunday",open:"07:00 - 20:00"}];function Et(){return C`
    <footer class="hidden-section grid justify-items-center gap-24 bg-[#333]">
      ...
      >
        ...
        ${Ct.reduce((e,{title:t,links:n},i)=>e+C`
              <section
  ...
  `}function Lt({id:e,type:t,style:n,label:i,customId:s,useSelect:a,useTextArea:r}){return C`
