(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const a of n)if(a.type==="childList")for(const o of a.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function i(n){const a={};return n.integrity&&(a.integrity=n.integrity),n.referrerpolicy&&(a.referrerPolicy=n.referrerpolicy),n.crossorigin==="use-credentials"?a.credentials="include":n.crossorigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(n){if(n.ep)return;n.ep=!0;const a=i(n);fetch(n.href,a)}})();function C(e,...t){return String.raw({raw:e},...t)}function Ye(e){return new Promise(t=>setTimeout(t,e))}function Te(e,t){if(!(e instanceof MouseEvent))return!1;const{clientX:i,clientY:s}=e,{top:n,left:a,width:o,height:d}=t.getBoundingClientRect();return n<=s&&a<=i&&i<=a+o&&s<=n+d}const Ue=[{name:"Home",href:"#home"},{name:"About",href:"#about"},{name:"Offer",href:"#offer"},{name:"Menu",href:"#menu"},{name:"Gallery",href:"#gallery"},{name:"Contact",href:"#contact"}];function Ke(){return C`
    <header id="navbar">
      <div class="main-container flex items-center justify-between">
        ...
        <nav id="nav-link-container" class="flex gap-8">
          ${Ue.reduce((e,{name:t,href:i})=>e+C`<a class="smooth-tab nav-link" href="${i}">${t}</a>`,"")}
        </nav>
      </div>
    </header>
  ...
  `}const Ze=new Intl.NumberFormat("id-ID",{style:"currency",currency:"IDR",minimumFractionDigits:0});function Ce(e){return Ze.format(e)}function et({name:e,price:t,image:i,index:s,description:n}){const a=s%3;return C`
    <div
    ...
    <section id="offer" class="hidden-section grid gap-12" data-index="2">
      ...
      >
        <div class="swiper-wrapper cursor-grab select-none">
          ${it.reduce((e,t,i)=>e+et({...t,index:i}),"")}
        </div>
        <div class="swiper-pagination"></div>
      </div>
    </section>
  `}function nt({category:e,products:t}){return C`
    <div
      id=${e}
      style="display: none;"
  ...
  `}const at=["breakfast","lunch","dinner"],rt=[{name:"Salted Fried Chicken",price:42e4,description:"Lorem ipsum, dolor sit amet consectetur adipisicing elit. Consequuntur ut necessitatibus obcaecati nobis suscipitiste, blanditiis quam explicabo doloremque eveniet.",image:"/assets/menu/breakfast/breakfast-1.webp"},{name:"Italian Sauce Mushroom",price:32e4,description:"Lorem ipsum, dolor sit amet consectetur adipisicing elit. Consequuntur ut necessitatibus obcaecati nobis suscipitiste, blanditiis quam explicabo doloremque eveniet.",image:"/assets/menu/breakfast/breakfast-2.webp"},{name:"Fried Potato with Garlic",price:15e4,description:"Lorem ipsum, dolor sit amet consectetur adipisicing elit. Consequuntur ut necessitatibus obcaecati nobis suscipitiste, blanditiis quam explicabo doloremque eveniet.",image:"/assets/menu/breakfast/breakfast-3.webp"}],Q=[...Array(2)].reduce(e=>[...e,...rt],[]),ot=[{category:"breakfast",products:Q},{category:"lunch",products:Q},{category:"dinner",products:Q}];function lt(){return C`
    ...
    >
      ...
      <div class="flex items-center justify-center gap-4">
        ${at.reduce((e,t,i)=>{const s=i%3;return e+C`
              <div
      ...
      <div class="main-container">
        ${ot.reduce((e,{category:t,products:i})=>e+nt({category:t,products:i}),"")}
      </div>
    </section>
  `}const dt=[{name:"Breakfast 1",image:"/assets/menu/breakfast/breakfast-1.webp"},{name:"Breakfast 2",image:"/assets/menu/breakfast/breakfast-2.webp"},{name:"Breakfast 3",image:"/assets/menu/breakfast/breakfast-3.webp"}],ct=[...Array(2)].reduce(e=>[...e,...dt],[]);function ut(){return C`
    <section
      id="gallery"
    ...
    >
      ...
      >
        ${ct.reduce((e,{name:t,image:i})=>e+C`
              <img
  ...
  `}const ft={AtIcon:vt,XMarkIcon:mt,PhoneIcon:gt,MapPinIcon:pt,SpinnerIcon:bt,WhatsAppIcon:xt,InstagramIcon:wt,PaperAirplaneIcon:ht};function H({style:e,iconName:t}){const i=ft[t];return i({style:e!=null?e:"h-6 w-6"})}function pt({style:e}){return C`
    <svg
  ...
  `}function yt({id:e,type:t,label:i,style:s,useTextArea:n}){return C`
    <div
  ...
  `}const St=[{href:"https://goo.gl/maps/PxD3wGwbXDKQP5ML9",style:"hover:bg-red-400",title:"Location",iconName:"MapPinIcon"},{href:"mailto:site@buburnusantara.com",style:"hover:bg-blue-400",title:"Email",iconName:"AtIcon"},{href:"tel:+6285692807048",style:"hover:bg-green-400",title:"Phone",iconName:"PhoneIcon"},{href:"https://www.instagram.com/buburnusantara.id",style:"hover:bg-rose-400",title:"Instagram",iconName:"InstagramIcon"},{href:"https://wa.me/6285692807048",style:"hover:bg-green-400",title:"WhatsApp",iconName:"WhatsAppIcon"}],Tt=[{id:"name",label:"Name"},{id:"email",label:"Email",type:"email"},{id:"message",label:"Message",useTextArea:!0}];function Ct(){return C`
    <section
      id="contact"
        ...
        >
          ...
          <div class="flex flex-wrap justify-center gap-4">
            ${St.reduce((e,{href:t,style:i,title:s,iconName:n})=>e+C`
                  <a
                    href="${t}"
                    class="${i} flex gap-2 rounded-md bg-main-background p-2 text-black/75 shadow transition
  ...
  `}const he=[{name:"About Us",href:"#"},{name:"Our Chef",href:"#"},{name:"Events",href:"#"},{name:"Testimonials",href:"#"}],Et=[{title:"Company",links:he},{title:"Legal",links:he}],kt=[{day:"Monday",open:"07:00 - 20:00"},{day:"Tuesday",open:"07:00 - 20:00"},{day:"Wednesday",open:"07:00 - 20:00"},{day:"Thursday",open:"Closed"},{day:"Friday",open:"07:00 - 20:00"},{day:"Saturday",open:"07:00 - 20:00"},{day:"Sunday",open:"07:00 - 20:00"}];function $t(){return C`
    <footer class="hidden-section grid justify-items-center gap-24 bg-[#333]">
      <div class="main-container flex items-start justify-center gap-24">
        ...
        ${Et.reduce((e,{title:t,links:i},s)=>e+C`
              <section
  ...
  `}function Pt({id:e,type:t,style:i,label:s,useSelect:n,useTextArea:a}){return C`
  ...
  `}const It=[{id:"firstName",label:"First Name"},{id:"lastName",label:"Last Name"},{id:"email",type:"email",label:"Email",style:"col-span-2"},{id:"people",label:"How Many People",useSelect:!0},{id:"phone",type:"tel",label:"Phone"},{id:"date",type:"date",label:"Date"},{id:"time",type:"time",label:"Time"},{id:"message",label:"Message",style:"col-span-2",useTextArea:!0}];function Ot(){return C`
    <div>
