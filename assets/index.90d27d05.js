(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const l of a.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&i(l)}).observe(document,{childList:!0,subtree:!0});function n(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerpolicy&&(a.referrerPolicy=s.referrerpolicy),s.crossorigin==="use-credentials"?a.credentials="include":s.crossorigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(s){if(s.ep)return;s.ep=!0;const a=n(s);fetch(s.href,a)}})();function C(e,...t){return String.raw({raw:e},...t)}function Ue(e){return new Promise(t=>setTimeout(t,e))}function Ce(e,t){if(!(e instanceof MouseEvent))return!1;const{clientX:n,clientY:i}=e,{top:s,left:a,width:l,height:d}=t.getBoundingClientRect();return s<=i&&a<=n&&n<=a+l&&i<=s+d}const Je=[{name:"Home",href:"#home"},{name:"About",href:"#about"},{name:"Favorite",href:"#offer"},{name:"Menu",href:"#menu"},{name:"Gallery",href:"#gallery"},{name:"Contact",href:"#contact"}];function Qe(){return C`
    <header id="navbar">
      ...
      >
        ...
        <nav id="nav-links-container">
          ${Je.reduce((e,{name:t,href:n})=>e+C`<a class="nav-link smooth-tab rounded-md" href="${n}"
                >${t}</a
              >`,"")}
        </nav>
      </div>
  ...
  `}function ot(){return C`
    ...
    >
      ...
      <div class="flex flex-wrap items-center justify-center gap-4">
        ${at.reduce((e,t,n)=>{const s=`fade-delay-${(1+n%4)*100}`;return e+C`
      ...
      <div class="main-container md:min-h-[616px]">
        ${rt.reduce((e,{category:t,products:n})=>e+lt({category:t,products:n}),"")}
      </div>
    </section>
  ...
  `}const ut={AtIcon:gt,XMarkIcon:pt,PhoneIcon:ht,MapPinIcon:ft,SpinnerIcon:vt,WhatsAppIcon:yt,InstagramIcon:bt,PaperAirplaneIcon:mt};function _({style:e,iconName:t}){const n=ut[t];return n({style:e!=null?e:"h-6 w-6"})}function ft({style:e}){return C`
    <svg
  ...
  `}const xt=[{href:"https://goo.gl/maps/PxD3wGwbXDKQP5ML9",style:"hover:bg-red-400 focus-visible:bg-red-400",title:"Location",iconName:"MapPinIcon"},{href:"mailto:site@buburnusantara.com",style:"hover:bg-blue-400 focus-visible:bg-blue-400",title:"Email",iconName:"AtIcon"},{href:"tel:+6285692807048",style:"hover:bg-green-400 focus-visible:bg-green-400",title:"Phone",iconName:"PhoneIcon"},{href:"https://www.instagram.com/buburnusantara.id",style:"hover:bg-rose-400 focus-visible:bg-rose-400",title:"Instagram",iconName:"InstagramIcon"},{href:"https://wa.me/6285692807048",style:"hover:bg-green-400 focus-visible:bg-green-400",title:"WhatsApp",iconName:"WhatsAppIcon"}],Tt=[{id:"name",label:"Name"},{id:"email",type:"email",label:"Email",customId:"contact-email"},{id:"message",label:"Message",customId:"contact-message",useTextArea:!0}];function St(){return C`
    <section
      id="contact"
      ...
      >
        ...
        >
          ...
          <div class="flex flex-wrap justify-center gap-4">
            ${xt.reduce((e,{href:t,style:n,title:i,iconName:s})=>e+C`
                  <a
                    href="${t}"
  ...
  `}function Lt({id:e,type:t,style:n,label:i,customId:s,useSelect:a,useTextArea:l}){return C`
